    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">Generated by Iftyar (https://iftyar.vercel.app)</div>
        </body>
      </html>
    `)
        ...
        <div className="calendar-export-wrap">
          <div className="calendar-source-row">
            <div className="calendar-source-info">
              <span className="eyebrow eyebrow--slate">Source Calendar</span>
              <span className="calendar-source-current">{calendarSource}</span>
            </div>
            <div className="calendar-select-wrap">
              <select
                aria-label="Select Ramadan Timetable Source"
          ...
          >
            ...
            <span style={{ fontSize: '0.75rem', opacity: 0.85, marginLeft: '0.2rem' }}>
              {calendarMenuOpen ? '▲' : '▼'}
            </span>
          </button>
